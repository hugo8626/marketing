...
export const portfolioProjects: PortfolioProject[] = [
  {
    ...
    // HERO
    pageTitle: "De One Page básica a web que genera reservas",
    pageIntro: "Hotel boutique y restaurante en la Costa Brava (Girona)",
    websiteUrl: "https://www.tavernadelasal.com",
    websiteLabel: "www.tavernadelasal.com",

    // CONTEXTO
    context: "Un negocio que había crecido, pero su web no acompañaba",
    pageDescription:
    ...
    featuredImageAlt:
      "Diseño web de Taverna de la Sal para hotel boutique y restaurante",
    gallery: [
      {
        src: "/terraza.png",
        alt: "Zona exterior de Taverna de la Sal",
      },
      {
        src: "/ruinas.png",
        alt: "Página interior del proyecto Taverna de la Sal",
      },
    ],
    finimg: "",
...

  {
    ...
    // HERO
    pageTitle: "De no tener presencia online a una web que vende.",
    pageIntro:
    ...
    // PROBLEMA
    objective:
      "No era solo no tener web, sino no tener un sistema que guiara al cliente y convirtiera el interés en ventas.",
    problemItems: [
    ...
    featuredImageAlt: "Diseño web ecommerce para Bon Toc",
    gallery: [
      {
        src: "/sensacion.png",
        alt: "Página de producto del ecommerce Bon Toc",
      },
      {
        src: "/regalo.png",
        alt: "Regalos comestibles en la web de Bon Toc",
      },
    ],
    finimg: "",
