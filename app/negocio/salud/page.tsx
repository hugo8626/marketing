...
//
// Home principal.
// Mantiene el contenido original del usuario y corrige
// estructura, semántica y responsive tomando como guía
// la disposición visual aprobada.
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:items-center">
          <div className="flex flex-col gap-6">
            ...
            <ul className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
              <li className="flex items-start gap-3 rounded-[8px] bg-white p-4 text-sm">
                <svg
            ...
            <section className="flex flex-col gap-4">
              ...
              <p className="text-body">¿Qué tipo de negocio tienes?</p>

              <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
                <article className="card min-h-[220px]">
                  <h3 className="card-title max-w-[12ch]">
                    Tengo un negocio turístico
                  </h3>
                  <p className="text-small max-w-[22ch]">
                    Quiero más reservas directas (sin pagar comisiones)
                  </p>
                </article>

                <article className="card min-h-[220px]">
                  <h3 className="card-title max-w-[14ch]">
                ...
                <article className="card min-h-[220px] md:col-span-2 xl:col-span-1">
                  <h3 className="card-title max-w-[12ch]">
                    Tengo una marca personal
                  </h3>
                  <p className="text-small max-w-[20ch]">
