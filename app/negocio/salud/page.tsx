 ...
 * Optimizada con SEO para atraer pacientes y generar citas.
 */
...
export const metadata: Metadata = {
  title: "Diseño web para clínicas y salud en Girona",
  description:
    "Diseño web para clínicas, consultas privadas y centros de bienestar que quieren generar confianza, conseguir más citas y atraer pacientes en Girona.",
  alternates: {
    canonical: "/negocio/salud",
  },
  openGraph: {
    title: "Diseño web para clínicas y salud | Fityx Digital",
    description:
      "Creamos páginas web para clínicas y profesionales de la salud enfocadas en generar confianza, facilitar el contacto y conseguir más citas.",
    url: "/negocio/salud",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Diseño web para clínicas y profesionales de la salud",
      },
    ],
    locale: "es_ES",
    type: "website",
    ...
    <main>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2 lg:items-center">
          <div className="flex flex-col gap-6">
            <header className="flex flex-col gap-6">
              <p className="eyebrow">Diseño web para salud</p>
              ...
              <p className="text-body max-w-2xl">
                Diseñamos páginas web para clínicas, centros de bienestar y
                profesionales de la salud en Girona, pensadas para generar
                confianza y facilitar la reserva de citas.
              </p>

              <p className="text-body max-w-2xl">
                Creamos webs con un objetivo claro: que tus pacientes confíen en
                ti y den el paso de pedir cita.
              </p>
            </header>
            ...
            <ul className="grid gap-3 sm:grid-cols-2 xl:grid-cols-1">
              <li className="flex items-center gap-3 rounded-[8px] bg-white p-4 text-sm">
                ...
                <span>Más citas directas desde tu web</span>
              </li>
              ...
              <li className="flex items-center gap-3 rounded-[8px] bg-white p-4 text-sm">
                ...
                <span>Más pacientes sin depender de terceros</span>
              </li>
            </ul>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 lg:grid-cols-2">
          <div className="order-1 flex flex-col gap-4 lg:order-2">
            ...
            <p className="text-body">
              Se trata de crear una web que genere confianza y facilite que el
              paciente contacte contigo.
            </p>
          </div>
          ...
          <ul className="order-2 flex flex-col gap-3 lg:order-1">
            {[
              ...
              >
                <span className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[#F9F5ED] text-[var(--primary)]">
                  ✔
                </span>
                <span>{item}</span>
              </li>
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-5">
          ...
          <blockquote className="rounded-[8px] border-l-2 border-[var(--primary)] px-4 py-3">
            ...
            <span className="block">
              Hacemos webs que generan confianza y pacientes.
            </span>
          </blockquote>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-7xl">
          <header className="mb-10 flex flex-col items-center text-center">
            ...
            <h2 className="section-title max-w-4xl">
              ...
              <span className="block text-[var(--primary)]">
                y tener un canal de captación de pacientes
              </span>
            </h2>
          </header>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <article className="rounded-[12px] border border-[var(--primary)] p-6">
              ...
              <ul className="flex flex-col gap-4">
                {[
                  "Web pensada para generar citas",
                  "Diseño profesional adaptado a tu especialidad",
                  "Mensaje claro que genera confianza",
                  "Optimizada para atraer pacientes en Girona",
                ].map((item) => (
                  <li
                    key={item}
                    className="flex items-start gap-3 rounded-[8px] bg-[#F5F5F5] p-4"
          ...
          <ul className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {[
              ...
              <li
                ...
                className="flex items-start gap-3 rounded-[8px] bg-white p-4"
              >
                <span className="inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#F0ECE4] text-[var(--primary)]">
                  ✔
                </span>
                <span>{item}</span>
              </li>
      ...
      <section className="px-6 py-16 md:px-10 md:py-24 lg:px-14 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <header className="mb-10">
            ...
            <h2 className="section-title">
              Todo lo que necesitas para conseguir pacientes desde tu web
            </h2>
          </header>
          ...
          <div className="grid gap-10 md:grid-cols-2 xl:grid-cols-3">
            <article className="flex flex-col gap-3">
              ...
              <h3 className="card-title">
                Entendemos tu consulta y tus pacientes
              </h3>
              <p className="text-small">
                Analizamos tu situación, el tipo de paciente que quieres atraer
                y tus objetivos.
              </p>
            </article>
            ...
            <article className="flex flex-col gap-3">
              ...
              <h3 className="card-title">
                Diseñamos una web pensada para generar confianza
              </h3>
              <p className="text-small">
                Creamos una web clara, profesional y adaptada a tu especialidad,
                enfocada en transmitir confianza y facilitar el contacto.
              </p>
            </article>
            ...
            <article className="flex flex-col gap-3">
              ...
              <h3 className="card-title">
                Lanzamos tu web lista para atraer pacientes
              </h3>
              <p className="text-small">
                Publicamos tu web optimizada para posicionarse en Google y
                empezar a generar citas.
              </p>
            </article>
          </div>
        </div>
      ...
      <section className="px-6 py-16 md:px-10 md:py-24 lg:px-14 lg:py-28">
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 text-center">
          <h2 className="section-title">
            Tu web debería transmitir confianza
